...
CREATE TABLE IF NOT EXISTS pet_entities (id INTEGER PRIMARY KEY, pet_id INTEGER NOT NULL, sex CHAR, nickname TEXT, give_birth_date DATETIME, lovePoints INTEGER NOT NULL,hungrySince DATETIME, updatedAt DATETIME, createdAt DATETIME);
