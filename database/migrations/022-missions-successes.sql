...
CREATE TABLE IF NOT EXISTS mission_tags(id INTEGER PRIMARY KEY, textTag VARCHAR(64) NOT NULL, idObject INTEGER NOT NULL, typeObject VARCHAR(64) NOT NULL, updatedAt DATETIME, createdAt DATETIME);
