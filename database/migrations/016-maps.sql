...
ALTER TABLE armors ADD frenchMasculine INTEGER;
ALTER TABLE armors ADD frenchPlural INTEGER;
ALTER TABLE weapons ADD frenchMasculine INTEGER;
ALTER TABLE weapons ADD frenchPlural INTEGER;
ALTER TABLE potions ADD frenchMasculine INTEGER;
ALTER TABLE potions ADD frenchPlural INTEGER;
ALTER TABLE objects ADD frenchMasculine INTEGER;
ALTER TABLE objects ADD frenchPlural INTEGER;
