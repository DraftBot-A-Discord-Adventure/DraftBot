...
INSERT INTO players_backup SELECT id, score, weeklyScore, level, experience, money, badges, entity_id, guild_id, updatedAt, createdAt, topggVoteAt, nextEvent, class, pet_id, last_pet_free, DATETIME(0,'unixepoch'), DATETIME(0,'unixepoch'), -1, -1, DATETIME(0,'unixepoch'), ':smiley:' FROM players;
DROP TABLE players;
