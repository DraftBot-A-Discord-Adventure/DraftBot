...
CREATE TABLE players_backup (id INTEGER PRIMARY KEY, score INTEGER NOT NULL, weeklyScore INTEGER NOT NULL, level INTEGER NOT NULL, experience INTEGER NOT NULL, money INTEGER NOT NULL, badges TEXT, entityId INTEGER NOT NULL, guildId INTEGER, updatedAt DATETIME, createdAt DATETIME, topggVoteAt DATETIME, nextEvent INTEGER, class INTEGER, petId INTEGER, lastPetFree DATETIME, effectEndDate DATETIME, effectDuration INTEGER NOT NULL, mapLinksId INTEGER, startTravelDate DATETIME, effect TEXT);
INSERT INTO players_backup SELECT id INTEGER , score INTEGER , weeklyScore , level , experience , money , badges , entityId , guildId , updatedAt , createdAt , topggVoteAt , nextEvent , class , petId , lastPetFree , effectEndDate , effectDuration , NULL , startTravelDate, effect FROM players;
DROP TABLE players;
