...
CREATE TABLE IF NOT EXISTS map_links( id INTEGER PRIMARY KEY, firstMap INTEGER, endMap INTEGER, tripDuration INTEGER, updatedAt DATETIME, createdAt DATETIME);
