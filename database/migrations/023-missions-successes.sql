...
CREATE TABLE IF NOT EXISTS mission_slots(id INTEGER PRIMARY KEY, playerId INTEGER NOT NULL, missionId TEXT NOT NULL, missionVariant INTEGER NOT NULL, missionObjective INTEGER NOT NULL, expiresAt DATETIME, numberDone INTEGER NOT NULL, gemsToWin INTEGER NOT NULL, xpToWin INTEGER NOT NULL, moneyToWin INTEGER NOT NULL, createdAt DATETIME, updatedAt DATETIME);
