...
CREATE TABLE IF NOT EXISTS daily_mission(id INTEGER NOT NULL, missionId TEXT, objective INTEGER NOT NULL, variant INTEGER NOT NULL, gemsToWin INTEGER NOT NULL, xpToWin INTEGER NOT NULL, updatedAt DATETIME, createdAt DATETIME);
