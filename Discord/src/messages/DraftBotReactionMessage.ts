...
export class DraftBotReactionMessage extends DraftBotEmbed {
	 ...
	 */
	private readonly _endCallback: CallbackLike | null;
	 ...
	 */
	get collector(): ReactionCollector | null {
	 ...
	 * @private
	 */
	private _sentMessage: Message | null = null;

	/**
	 * Returns the message that was sent
	 */
	get sentMessage(): Message | null {
	 ...
	 */
	async reply(interaction: DraftbotInteraction, collectorCallback: ((collector: ReactionCollector) => void) | null = null): Promise<Message> {
	 ...
	 * @param collectorCallback
	 */
	async editReply(interaction: DraftbotInteraction, collectorCallback: ((collector: ReactionCollector) => void) | null = null): Promise<Message> {
	 ...
	 */
	async send(channel: DraftbotChannel, collectorCallback: ((collector: ReactionCollector) => void) | null = null): Promise<Message> {
	 ...
	 */
	getFirstReaction(): MessageReaction | null {
		if (!this._collector) {
			throw MESSAGE_NOT_SENT_ERROR;
		}
		return this._collector.collected.first() ?? null;
	}
	 ...
	 * @private
	 */
	private async collectAndReact(collectorCallback: ((collector: ReactionCollector) => void) | null = null): Promise<void> {
...
export class DraftBotReactionMessageBuilder {
	...
	private _endCallback: CallbackLike | null = null;
