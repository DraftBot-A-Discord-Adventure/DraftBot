...
export async function cartCollector(packet: ReactionCollectorCreationPacket, context: PacketContext): Promise<void> {
	...
	await DiscordCollectorUtils.createAcceptRefuseCollector(interaction, embed, packet, context, DraftBotIcons.cart_small_event.accept, DraftBotIcons.cart_small_event.refuse);
}
