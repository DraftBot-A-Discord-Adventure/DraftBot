...
import {CommandLeagueRewardPacketReq, CommandLeagueRewardSuccessPacketRes} from "../../../../Lib/src/packets/commands/CommandLeagueRewardPacket";
	...
	await interaction.editReply({
		embeds: [new DraftBotEmbed()
			...
			.setDescription(i18n.t(`commands:leagueReward.description.${packet.rank === 1 ? "first" : "other"}`, {
				lng,
				gloryPoints: packet.gloryPoints,
				rank: packet.rank,
