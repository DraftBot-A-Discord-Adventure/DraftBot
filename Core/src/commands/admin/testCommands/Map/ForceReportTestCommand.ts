 ...
 */
const forceReportTestCommand: ExecuteTestCommandLike = async (player, args, response, client) => {
	await CommandsTest.getTestCommand("atravel").execute(player, ["5000"], response, client);
