 ...
 * @param language
 */
function getClassField(profileModule: TranslationModule, playerClass: Class, language: Language): EmbedField {
	return {
 ...
 * @param language
 */
async function getLocationField(profileModule: TranslationModule, askedPlayer: Player, language: Language): Promise<EmbedField> {
	return {
 ...
 * @param language
 */
function getPetField(profileModule: TranslationModule, pet: PetEntity, petModel: Pet, language: Language): EmbedField {
	return {
 ...
 * @returns {Promise<void>}
 */
async function sendMessageAllBadgesTooMuchBadges(player: Player, language: Language, interaction: CommandInteraction): Promise<void> {
	let content = "";
	const badges = player.badges.split("-");
