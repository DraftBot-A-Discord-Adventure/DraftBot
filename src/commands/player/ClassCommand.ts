 ...
 * @param interaction
 */
async function createDisplayClassEmbedAndSendIt(classTranslations: TranslationModule, allClasses: Class[], language: Language, player: Player, interaction: CommandInteraction): Promise<Message> {
