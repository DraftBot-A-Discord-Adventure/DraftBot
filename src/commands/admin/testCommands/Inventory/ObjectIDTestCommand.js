 ...
 */
const objectIDTestCommand = async (language, message, args) => {
	...
	return format(module.exports.commandInfo.messageWhenExecuted, {object: objectText});
};

module.exports.execute = objectIDTestCommand;