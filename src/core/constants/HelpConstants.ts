export abstract class HelpConstants {
	static readonly ACCEPTED_SEARCH_WORDS = {
		...
		GUILD_KICK: ["guildkick", "gkick", "gk", "expulser", "expulsion", "kick", "kickguild", "kickguilde", "expulserguilde", "expulserpoisson", "virer", "eg"],
		GUILD_INVITE: ["guildadd", "gadd", "ga", "ajouter", "ajout", "add", "addguild", "addguilde", "ajouterguilde",
			"ajouterpoisson", "invitemember", "ag", "guildinvite", "guildi", "invitationguilde", "invitationguild"],
