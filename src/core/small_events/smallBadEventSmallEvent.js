...
const executeSmallEvent = async function(message, language, entity, seEmbed) {
	...
	const base = JsonReader.small_events.smallBadEvent.emote + " " + JsonReader.smallEventsIntros.getTranslation(language).intro[randInt(0, JsonReader.smallEventsIntros.getTranslation(language).intro.length)];
