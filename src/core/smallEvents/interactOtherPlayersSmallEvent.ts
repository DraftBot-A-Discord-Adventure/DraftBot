 ...
 * @param language
 */
async function getPetName(otherPlayer: Player, language: Language): Promise<string> {
 ...
 * @param player
 */
async function sendACoin(otherPlayer: Player, channel: TextBasedChannel, language: Language, player: Player): Promise<void> {
