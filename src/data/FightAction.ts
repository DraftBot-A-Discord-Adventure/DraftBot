...
import {FightActionType} from "draftbot_lib/interfaces/FightActionType";
...
export class FightAction extends Data<string> {
    ...
    public use(fight: FightController, sender: Fighter, receiver: Fighter, turn: number): FightActionResult  {
        return FightActionDataController.getFightActionFunction(this.id)(fight, this, sender, receiver, turn);
    }
}
